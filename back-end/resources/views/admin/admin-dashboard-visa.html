...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/admin-dashboard-visa.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:28 GMT -->
<head>
    ...
    <div class="sidebar-nav-body">
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                ...
                <li class="page-active"><a href="admin-dashboard-visa.html"><i class="la la-plane mr-2"></i>Visa Application</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white">Visa Application</h2>
                            </div>
                                ...
                                <div class="table-form table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>7 Days</td>
                                            <td>Apr 02 2020</td>
                                            <td><span class="badge badge-warning text-white py-1 px-2">New</span></td>
                                            <td>
                                                <div class="table-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>3 Days</td>
                                            <td>Apr 02 2020</td>
                                            <td><span class="badge badge-success py-1 px-2">Approved</span></td>
                                            <td>
                                                <div class="table-content">
                                                    <a href="#" class="theme-btn theme-btn-small mr-2" data-toggle="tooltip" data-placement="top" title="View"><i class="la la-eye"></i></a>
                                                    <a href="#" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="Edit"><i class="la la-edit"></i></a>
