...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/admin-dashboard-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:28 GMT -->
<head>
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                ...
                <li>
                    ...
                    <a href="admin-dashboard-orders.html"><i class="la la-users mr-2 text-color-4"></i>Travellers</a>
                    <ul class="toggle-drop-menu">
                        <li><a href="admin-dashboard-orders-details.html">Traveller Details</a></li>
                    </ul>
                </li>
                <li><a href="admin-dashboard-visa.html"><i class="la la-plane mr-2 text-color-5"></i>Visa Application</a></li>
                <li class="page-active"><a href="admin-dashboard-reviews.html"><i class="la la-star mr-2"></i>Reviews</a></li>
                                ...
                                <div class="comments-list">
                                    <div class="comment">
                                        ...
                                        <div class="comment-body">
                                            <div class="meta-data">
                                                <h3 class="comment__author">Grand Plaza Serviced Apartments</h3>
                                                <div class="meta-data-inner d-flex">
                                                    <p class="comment__meta mr-1">By <a href="#">John Smith</a></p>
                                            ...
                                            <p class="comment-content">
                                                Our stay was pleasant and welcoming. We stayed in an apartment meant for 3 adults with kitchen facilities. The cleaning services were superp. We liked the laundry and kitchen cleaning services on top of the regular cleaning services.
                                            </p>
                                            <div class="comment-reply">
                                                <a class="theme-btn" href="#" data-toggle="modal" data-target="#modalPopup">
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="comment-body">
                                            <div class="meta-data">
                                                <h3 class="comment__author">Three-Hour South Beach Lunch Tour </h3>
                                                <div class="meta-data-inner d-flex">
                                                    <p class="comment__meta mr-1">By <a href="#">Alex smith</a></p>
                                                    <span class="ratings d-flex align-items-center mr-1">
                                                        <i class="la la-star"></i>
                                                        <i class="la la-star"></i>
                                                        <i class="la la-star"></i>
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="comment-body">
                                            <div class="meta-data">
                                                <h3 class="comment__author">7 Night Western Caribbean Cruise</h3>
                                                <div class="meta-data-inner d-flex">
                                                    <p class="comment__meta mr-1">By <a href="#">Alex smith</a></p>
                                                    <span class="ratings d-flex align-items-center mr-1">
                                                        <i class="la la-star"></i>
                                    ...
                                    <div class="comment mb-0 pb-0 border-bottom-0">
                                        ...
                                        <div class="comment-body">
                                            <div class="meta-data">
                                                <h3 class="comment__author">Two Hour Walking Tour of Manhattan</h3>
                                                <div class="meta-data-inner d-flex">
                                                    <p class="comment__meta mr-1">By <a href="#">Alex smith</a></p>
                                                    <span class="ratings d-flex align-items-center mr-1">
                                                        <i class="la la-star"></i>
