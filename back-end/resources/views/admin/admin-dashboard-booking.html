...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/admin-dashboard-booking.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:27 GMT -->
<head>
    ...
    <div class="sidebar-nav-body">
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                ...
                <li class="page-active"><a href="admin-dashboard-booking.html"><i class="la la-shopping-cart mr-2"></i>Booking</a></li>
                <li>
                        ...
                        <div class="form-box">
                            ...
                            <div class="form-content pb-2">
                                ...
                                <div class="card-item flight-card card-item-list card-item--list">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <h3 class="card-title">London to Paris</h3>
                                            <span class="badge badge-success ml-2">Approved</span>
                                        </div>
                                        <ul class="list-items list-items-2 pt-2 pb-3">
                                            <li><span>Start date:</span>12 December 2019</li>
                                            <li><span>End date:</span>12 Jun 2020</li>
                                            <li><span>Booking details:</span> 2 People</li>
                                            <li><span>Client:</span> Mark Wing</li>
                                        </ul>
                                        <div class="btn-box">
                                            <a href="#" class="theme-btn theme-btn-small theme-btn-transparent" data-toggle="modal" data-target="#modalPopup"><i class="la la-envelope mr-1"></i>Send Message</a>
                                        </div>
                                ...
                                <div class="card-item car-card card-item-list card-item--list">
                                    <div class="card-img">
