...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/admin-dashboard-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:28 GMT -->
<head>
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                ...
                <li>
                    ...
                    <a href="#"><i class="la la-map-signs mr-2 text-color-10"></i>Locations</a>
                    <ul class="toggle-drop-menu">
                        <li><a href="admin-countries.html">Countries</a></li>
                        <li><a href="admin-airlines.html">Airlines</a></li>
                    </ul>
                </li>
                <li class="page-active"><a href="admin-dashboard-settings.html"><i class="la la-cog mr-2"></i>Settings</a></li>
