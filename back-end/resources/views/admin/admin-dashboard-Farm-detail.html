...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/admin-dashboard-traveler-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:27 GMT -->
<head>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white">Traveller Details</h2>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-box traveler-form border-0">
                            <div class="form-title-wrap">
                                <h3 class="title">Traveller Details</h3>
                            </div>
                                        ...
                                        <div class="card-item profile-card">
                                            ...
                                            <div class="card-body">
                                                <ul class="list-items list-items-2 list-items-3">
                                                    <li><span>Name:</span>Alex Smith</li>
                                                    <li><span>Email:</span>alexsmith@gmail.com</li>
                                                    <li><span>Phone:</span>+ 00 222 44 5678</li>
                                                    <li><span>Country:</span>Australia</li>
                                                    <li><span>City:</span>Sydney</li>
                                                    <li><span>Address:</span>Collins Street West, Victoria 8007,Australia.</li>
                                                    <li><span>Status:</span><i class="la la-check-circle text-color font-size-18" data-toggle="tooltip" data-placement="top" title="Active"></i></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div><!-- end col-lg-3 -->
                                    <div class="col-lg-9">
                                        <div class="section-tab section-tab-3 traveler-tab">
                                            <ul class="nav nav-tabs ml-0" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="traveler-detail-tab" data-toggle="tab" href="#traveler-detail" role="tab" aria-controls="traveler-detail" aria-selected="true">
                                                        Traveler's Details
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                        ...
                                        <div class="tab-content pt-4" id="myTabContent">
                                            <div class="tab-pane fade show active" id="traveler-detail" role="tabpanel" aria-labelledby="traveler-detail-tab">
                                                <div class="profile-item mb-4">
                                                    <h3 class="title">Passport Details</h3>
                                                    <div class="row pt-3">
                                                        <div class="col-lg-6">
                                                            <ul class="list-items list-items-2 list-items-3">
                                                                <li><span>Surname:</span>Alex</li>
                                                                <li><span>Given Name:</span>Smith</li>
                                                                <li><span>Sex:</span>M</li>
                                                                <li><span>Date of Birth:</span>Jun 03 1986</li>
                                                                <li><span>Date of Issue:</span>Jun 11 2004</li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <ul class="list-items list-items-2 list-items-3">
                                                                <li><span>Date of Expiry:</span>Dec 31 2020</li>
                                                                <li><span>Passport Number:</span>928321921</li>
                                                                <li><span>Issuing Post Name:</span>London</li>
                                                                <li><span>Nationality:</span>England</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                 ...
                                                 <div class="profile-item">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <h3 class="title">Emergency Contact Details</h3>
                                                            <ul class="list-items list-items-2 list-items-3 pt-3">
                                                                <li><span>Emergency Contact:</span>Adi Purdila</li>
                                                                <li><span>Address:</span>New York, United States</li>
                                                                <li><span>Email:</span>aidpurdial@gmail.com</li>
                                                                <li><span>Phone Number:</span>+ 00 222 44 5678</li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <h3 class="title">Insurance Details</h3>
                                                            <ul class="list-items list-items-2 list-items-3 pt-3">
                                                                <li><span>Insurance Company:</span>Pioneer Insurance Company Limited</li>
                                                                <li><span>Insurance Policy No:</span>12901321098</li>
                                                                <li><span>Company Email:</span>pioneerinsurance@gmail.com</li>
                                                                <li><span>Company Phone:</span>+ 00 222 44 5678</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div><!-- end profile-item -->
                                                ...
                                                <div class="profile-item">
                                                    <div class="table-form table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                <th scope="row"><a href="#" class="color-text">51373</a></th>
                                                                <td>
                                                                    <div class="table-content">
                                                                        <h3 class="title">Mercedes-Benz A 200 CDI</h3>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <th scope="row"><a href="#" class="color-text">51396</a></th>
                                                                <td>
                                                                    <div class="table-content">
                                                                        <h3 class="title">InterContinental New York Barclay</h3>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <th scope="row"><a href="#" class="color-text">51397</a></th>
                                                                <td>
                                                                    <div class="table-content">
                                                                        <h3 class="title">5 Nights Bermuda Cruise</h3>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <th scope="row"><a href="#" class="color-text">51398</a></th>
                                                                <td>
                                                                    <div class="table-content">
                                                                        <h3 class="title">Melia White House Hotel</h3>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <th scope="row"><a href="#" class="color-text">51399</a></th>
                                                                <td>
                                                                    <div class="table-content">
                                                                        <h3 class="title">Hut on Blue Water Beach Tour</h3>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <th scope="row"><a href="#" class="color-text">51400</a></th>
                                                                <td>
                                                                    <div class="table-content">
                                                                        <h3 class="title">Rome to Australia</h3>
                                                                    </div>
...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/admin-dashboard-traveler-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:28 GMT -->
</html>