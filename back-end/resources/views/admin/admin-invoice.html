...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/admin-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:28 GMT -->
<head>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white">Invoice</h2>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-box">
                            <div class="form-title-wrap">
                                <h3 class="title">Invoice Lists</h3>
                                ...
                                <div class="table-form table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-content">
                                                    <a href="#" class="theme-btn theme-btn-small" data-toggle="tooltip" data-placement="top" title="View"><i class="la la-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
